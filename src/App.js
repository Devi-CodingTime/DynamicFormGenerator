...
import { dropDownValue, optionValue } from './components/constatnt/constant';
...
function App() {
 ...
 const [itemStyle,setItemStyle] = useState(false);
  ...
  const addOptionvalue = (e) => {
    ...
    // setInitialData([...initialData, { label:initialData.label , type: formFields.type, options: [...initialData.options,inputValue] }]);
  };
  ...
  const onChangeHandler = (e)=>{
    ...
    // updated[e.target.name].push(e.target.value);
      console.log(updated);
